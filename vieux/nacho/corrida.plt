...
GNUTERM = "wxt"
Id = 0.0005757494
plot 'AtEDFAoutWON.dat' t 'antes ruido optico', 'AtEDFAout.dat' t 'c/ruido optico', 'PhotodetectedI.dat' axes x1y2 t 'antes ruido electrico', 'atElectFiltInput.dat' axes x1y2 t 'c/ ruido electrico', Id axes x1y2 t 'nivel decision' w l lw 2
#    EOF
