...
//  (*gauss).r_ex= -10.0;					// [dB] Extinction ratio [-10 ~ -15 Grosz priv. comm. 090210]
  (*gauss).r_ex= -999.0;					// [dB] Extinction ratio [-10 ~ -15 Grosz priv. comm. 090210]
...
void Pulses2Bits(GENDRIVE *Carrier, float RZPulsesTrain[], float RZPulsesTrainTime[], float Id, float *DSigmaNoise, char BitsDisc[]){
  unsigned long int i;
