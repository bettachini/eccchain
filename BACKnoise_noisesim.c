  ...
  */
  ...
  switch ((*Network).Efilt_CutOff ) { 
    case 7:
      ...
      *SamplingPoint= 3;	// opt: 12.5 ord 2 / elec: 7 ord 2, samplerate    =    8.0E10     = 2^3/ bit slot
 ...
 */
  ...
  */
  ...
  //filter ElectricalFilter(RZPulsesTrain, (*Carrier).NPtos_Tot, SamplingPoint, Network);
