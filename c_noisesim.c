...
void InputParameters(GENDRIVE *Carrier, SuperGaussian *Gauss, DeviceSTR *Network) {
  ...
  float FAtt1= -2.0 -1.0;				// [dB] Tx -> EDFAin 2dB fibre, 1.0dB insertion, 25 dB 128x1 splitter
  ...
  float FAtt2= -2.0 -1.0;				// [dB] EDFAout -> Rx 2dB fibre, 1.0dB insertion, 25 dB 1x128 splitter
  ...
  float EDFAgain= -24.0;				// [dB] Gain at EDFA <fixed approx>
