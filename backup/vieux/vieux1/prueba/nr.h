...
void dcorrel(double data1[], double data2[], unsigned long n, double ans[]);
...
void derivsan(int n,float x, float y[], float dydx[]);
...
void rk4s(float y[], float dydx[], int n, float x, float h, float yout[],
	void (*derivsan)(int, float, float [], float []));
...
void twofft(float data1[], float data2[], float fft1[], float fft2[],
	unsigned long n);
void dtwofft(double data1[], double data2[], double fft1[], double fft2[],
	unsigned long n);
